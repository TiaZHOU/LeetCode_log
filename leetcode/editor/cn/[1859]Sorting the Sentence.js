...
//leading or trailing spaces. Each word consists of lowercase and uppercase English 
//letters. 
//
...
var sortSentence = function(s)
{
    ...
    {
        let index = a[i].slice(-1);
        let temp = a[i].slice(0, a[i].length - 1);
        res[index - 1] = temp;
    }
    return res.join(' ');
};
